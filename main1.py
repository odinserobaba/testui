...
class TestAPI:
    ...
    def test_get_info1(self, param):
        # Тестовый код с использованием параметра
        print("Параметр:", param)
        assert ...

    @pytest.mark.parametrize("param", ["value1", "value2"])
    def test_get_info2(self, param):
        # Тестовый код с использованием параметра
        print("Параметр:", param)
        assert ...
    ...
    test_commands = [
        {
            ...
            'command': 'pytest test_api.py -k "TestAPI::test_get_info1[{param}]"',
            'description': 'This test checks the get info 1 endpoint'
        },
        {
            'name': 'Test get info 2',
            'command': 'pytest test_api.py -k "TestAPI::test_get_info2[{param}]"',
